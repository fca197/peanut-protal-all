...
// 查询表格
const queryForm = ref<ApsRoomConfig>({
  roomId: undefined,
  sectionId: undefined,
  stationId: undefined,
...
// 表格相关
const dataList = ref<ApsRoomConfig[]>([]);
...
// 表格选中事件
function handleSelectionChange(val: ApsRoomConfig[]) {
  ...
  <div class="app-container">
    <el-card class="search-wrapper" shadow="never">
      <el-form v-model="queryForm" inline>
        ...
        <el-form-item label="${column.comment}" prop="sectionId">
          <el-input
        ...
        <el-form-item label="${column.comment}" prop="stationId">
          <el-input
