    ...
    <el-card class="search-wrapper" shadow="never">
      <el-form v-model="queryForm" inline>
        <el-form-item label="报表ID" prop="reportConfigId">
          <el-input
            v-model="queryForm.reportConfigId"
            clearable
            placeholder="请输入报表ID"
          />
        </el-form-item>
...
const documentTitle = ref<string>('报表配置用户配置');
const dataBatchDeleteUrl = ref<string>(`${dtoUrl.value}/deleteByIdList`);

// 查询表格
const queryForm = ref<BaseReportConfigUser>({
...
// 表格相关
const dataList = ref<BaseReportConfigUser[]>([]);
...
// 表格选中事件
function handleSelectionChange(val: BaseReportConfigUser[]) {
