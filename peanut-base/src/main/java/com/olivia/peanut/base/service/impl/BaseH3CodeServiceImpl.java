...
public class BaseH3CodeServiceImpl extends MPJBaseServiceImpl<BaseH3CodeMapper, BaseH3Code> implements BaseH3CodeService {
  ...
  private MPJLambdaWrapper<BaseH3Code> getWrapper(BaseH3CodeDto obj) {
    ...
    if (Objects.nonNull(obj)) {
      q.eq(Objects.nonNull(obj.getLat()), BaseH3Code::getLat, obj.getLat()).eq(Objects.nonNull(obj.getLng()), BaseH3Code::getLng, obj.getLng())
          .eq(Objects.nonNull(obj.getValue0()), BaseH3Code::getValue0, obj.getValue0()).eq(Objects.nonNull(obj.getValue1()), BaseH3Code::getValue1, obj.getValue1())
          .eq(Objects.nonNull(obj.getValue2()), BaseH3Code::getValue2, obj.getValue2()).eq(Objects.nonNull(obj.getValue3()), BaseH3Code::getValue3, obj.getValue3())
          .eq(Objects.nonNull(obj.getValue4()), BaseH3Code::getValue4, obj.getValue4()).eq(Objects.nonNull(obj.getValue5()), BaseH3Code::getValue5, obj.getValue5())
          .eq(Objects.nonNull(obj.getValue6()), BaseH3Code::getValue6, obj.getValue6()).eq(Objects.nonNull(obj.getValue7()), BaseH3Code::getValue7, obj.getValue7())
          .eq(Objects.nonNull(obj.getValue8()), BaseH3Code::getValue8, obj.getValue8()).eq(Objects.nonNull(obj.getValue9()), BaseH3Code::getValue9, obj.getValue9())
          .eq(Objects.nonNull(obj.getValue10()), BaseH3Code::getValue10, obj.getValue10()).eq(Objects.nonNull(obj.getValue11()), BaseH3Code::getValue11, obj.getValue11())
          .eq(Objects.nonNull(obj.getValue12()), BaseH3Code::getValue12, obj.getValue12()).eq(Objects.nonNull(obj.getValue13()), BaseH3Code::getValue13, obj.getValue13())
          .eq(Objects.nonNull(obj.getValue14()), BaseH3Code::getValue14, obj.getValue14()).eq(Objects.nonNull(obj.getValue15()), BaseH3Code::getValue15, obj.getValue15())
