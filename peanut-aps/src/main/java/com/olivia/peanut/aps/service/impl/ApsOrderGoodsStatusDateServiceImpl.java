...
@Transactional
public class ApsOrderGoodsStatusDateServiceImpl extends MPJBaseServiceImpl<ApsOrderGoodsStatusDateMapper, ApsOrderGoodsStatusDate> implements
...
//    );
  ...
  private MPJLambdaWrapper<ApsOrderGoodsStatusDate> getWrapper(ApsOrderGoodsStatusDateDto obj) {
    ...
    if (Objects.nonNull(obj)) {
      q.eq(Objects.nonNull(obj.getOrderId()), ApsOrderGoodsStatusDate::getOrderId, obj.getOrderId())
