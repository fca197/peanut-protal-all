...
public class ApsMachineServiceImpl extends MPJBaseServiceImpl<ApsMachineMapper, ApsMachine> implements ApsMachineService {
  ...
  public @Override ApsMachineQueryListRes queryList(ApsMachineQueryListReq req) {
    ...
    List<ApsMachineDto> dataList = list.stream().map(t -> $.copy(t, ApsMachineDto.class))
  ...
  public @Override DynamicsPage<ApsMachineExportQueryPageListInfoRes> queryPageList(ApsMachineExportQueryPageListReq req) {
    ...
    if (Boolean.TRUE.equals(req.getQueryPage())) {
      ...
      IPage<ApsMachineExportQueryPageListInfoRes> dataList = list.convert(
          t -> $.copy(t, ApsMachineExportQueryPageListInfoRes.class));
    ...
    List<ApsMachineExportQueryPageListInfoRes> listInfoRes = $.copyList(records,
  ...
  private MPJLambdaWrapper<ApsMachine> getWrapper(ApsMachineDto obj) {
    ...
    if (Objects.nonNull(obj)) {
      q
          ...
          .likeRight(StringUtils.isNoneBlank(obj.getMachineNo()), ApsMachine::getMachineNo,
              obj.getMachineNo())
          .likeRight(StringUtils.isNoneBlank(obj.getMachineName()), ApsMachine::getMachineName,
              obj.getMachineName())
